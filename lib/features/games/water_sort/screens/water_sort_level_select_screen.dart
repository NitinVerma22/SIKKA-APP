...
class WaterSortLevelSelectScreen extends StatefulWidget {
  ...
  const WaterSortLevelSelectScreen({
    super.key,
...
class _WaterSortLevelSelectScreenState extends State<WaterSortLevelSelectScreen> {
  ...
  Future<void> _loadProgress() async {
    ...
    if (widget.globalMaxLevel >= widget.startLevel && widget.globalMaxLevel <= widget.endLevel) {
      ...
      final key = 'sikkaplay_ws_milestone_$($widget.milestoneId)_progress';
  ...
  List<Offset> _generateWindingPath(int totalLevels) {
    ...
    for (int i = 0; i <= totalLevels; i++) {
      ...
      double dx = 0.5 + 0.35 * math.sin((i - 1) * math.pi / 3 - math.pi / 2);
      ...
      appBar: AppBar(
        ...
        actions: [
          Container(
            ...
            child: Row(
              children: [
                const Icon(Icons.water_drop_rounded, color: Color(0xFF3B82F6), size: 16),
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text("$($widget.milestoneId)", style: GoogleFonts.outfit(color: const Color(0xFF3B82F6), fontSize: 12, fontWeight: FontWeight.w900, height: 1)),
                  ],
                ),
              ],
            ),
                    ...
                    children: [
                      RichText(
                        text: TextSpan(
                          ...
                          children: const [
                            TextSpan(text: "Level "),
                            TextSpan(text: "Milestones ✨", style: TextStyle(color: Color(0xFF3B82F6))),
                          ],
                        ),
                      ),
                          ...
                          child: Row(
                            children: [
                              Container(
                                ...
                                child: const Icon(Icons.emoji_events_rounded, color: Color(0xFF3B82F6), size: 28),
                              ),
      ...
      return Column(
        ...
        children: [
          Image.asset(
            ...
            width: 50,
            height: 50,
            errorBuilder: (c, e, s) => const Icon(Icons.rocket_launch, color: Color(0xFF3B82F6), size: 40),
          ),
          Container(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(color: const Color(0xFF3B82F6).withOpacity(0.2), blurRadius: 8, offset: const Offset(0, 4)),
          ],
          border: Border.all(color: isCurrent ? const Color(0xFF3B82F6) : const Color(0xFFE2E8F0), width: isCurrent ? 3 : 0),
        ),
        child: Center(
          child: isLocked
            ...
            : Text(
                "$levelNum",
                style: GoogleFonts.outfit(color: const Color(0xFF1E3A8A), fontSize: 20, fontWeight: FontWeight.bold),
              ),
        ),
      ),
    );
